<?php
	...
	class GameRoomAction {
		...
		public function quitRoomBySocketId($clients, $socketId) {
			...
			if($playerId != null) {
				$this->quitGameByPlayerId($clients, $playerId, $socketId);
			}
		}

		public function quitGameByPlayerId($clients, $playerId, $socketId) {
			$time = date('Y-m-j G:i:s');
